...
<picture>
  ...
  <img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/aryan2006-saini/aryan2006-saini/output/github-contribution-grid-snake.svg">
</picture>
...
jobs:
  generate:
    ...
    steps:
      - uses: Platane/snk@v3
        with:
          github_user_name: aryan2006-saini
          outputs: |
